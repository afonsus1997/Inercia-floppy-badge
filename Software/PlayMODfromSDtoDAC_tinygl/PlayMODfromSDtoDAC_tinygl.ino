...
void core1_displayTask() {
    ...
    Wire.setSDA(0);
    Wire.setSCL(1);
    frameBuffer = ZB_open(WINDOWX, WINDOWY, ZB_MODE_5R6G5B, NULL);
    // frameBuffer = ZB_open(WINDOWX, WINDOWY, ZB_MODE_5R6G5B, (void*)u8g2.getBufferPtr());
    glInit(frameBuffer);
    u8g2.setBufferPtr((uint8_t*)frameBuffer->pbuf);
